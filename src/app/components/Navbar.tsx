        ...
        <nav className="fixed flex flex-col w-full z-50 border border-black border-b-1  bg-transparent bg-opacity-50 backdrop-blur-sm ">
            <div className={`flex flex-row w-full gap-5 items-center p-4 h-[70px]`}>
                <div className="flex flex-row gap-8 w-full">
                    <h1 className={`text-3xl font-bold transition-colors duration-500 ease-in-out ${darkMode ? 'text-white' : 'text-main-pink'}`}><Link href="/">Swapify</Link></h1>
                ...
                {darkMode ? (
                    <div className="flex flex-row gap-6 pr-4">
                        ...
                        <Link className="relative hidden md:block min-h-[25px] max-h-[25px] min-w-[25px] max-w-[25px]" href="/shoppingcart"><Image className="cursor-pointer" src="/shopping-cart-dark.svg" layout="fill" alt="shopping cart"/></Link>
                    ...
                    <div className="flex flex-row gap-6 pr-4">
                        ...
                        <Image onClick={handleHamburgerClick} className="block md:hidden" src="/menu.svg" height="24" width="24" alt="exit"></Image>
                        <Link className="relative hidden md:block min-h-[25px] max-h-[25px] min-w-[25px] max-w-[25px]" href="/shoppingcart"><Image className="cursor-pointer" src="/shopping-cart.svg" layout="fill" alt="shopping cart"/></Link>
            ...
            <div className={`relative flex w-full h-[70px] gap-8 justify-center md:hidden ${hamburgerClicked ? "block" : "hidden"}`}>
                <Image src="/user.svg" height={24} width={24} alt="user"></Image>
                <Image src="/shopping-cart.svg" height={24} width={24} alt="shopping-cart"></Image>
                <Image src="/sun.svg" height={24} width={24} alt="sun"></Image>
                <Image src="/shopping-bag.svg" height={24} width={24} alt="shopping-bag"></Image>
            </div>
        </nav>
