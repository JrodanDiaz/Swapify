...
export default function Footer() {
    ...
    return (
        <div className={`flex relative items-center h-[300px] min-h-[300px] w-full border-y border-1 ${darkMode ? "border-bone-white" : "border-black"}`}>
            ...
            <div className={`hidden sm:flex justify-center items-center relative min-h-[100%] w-full max-w-[30%] border-r border-1 ${darkMode ? "border-bone-white" : "border-black"}`}>
                LOGO HERE
            </div>

            <div className="flex flex-row h-full w-full">
                <div className="hidden sm:flex justify-center h-full w-full">
                    <ul className="flex flex-col gap-5 justify-center items-center text-center">
